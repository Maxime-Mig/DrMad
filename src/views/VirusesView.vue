<template>
  <div>
    ...
    <CheckedList :data="filterViruses" :fields="['name', 'price']" :itemCheck="true" :checked="checked"
      :itemButton="{ show: true, text: 'Détail' }" :listButton="{ show: true, text: 'Afficher les virus selectionnés' }"
